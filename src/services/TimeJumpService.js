...
export async function executeTimeJump(minutes, agent, callbacks = {}) {
    ...
    if (typeof toastr !== 'undefined') {
        toastr.info(
            `Đang thực hiện dịch chuyển thời gian kể chuyện: ${minutes} phút...`,
            'Dịch chuyển Thời gian Kể chuyện ⏳'
        );
    }
    ...
    if (minutes >= 480) {
        ...
        if (typeof toastr !== 'undefined') {
            toastr.info(
                `Dịch chuyển thời gian thành công. Bộ đệm ngắn hạn tự động phai nhạt tự nhiên.`,
